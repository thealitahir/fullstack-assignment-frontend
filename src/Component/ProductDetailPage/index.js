            ...
            <div className="detail__description">
              <div className="detail__heading">
                <h1 className="detail__heading__text">
                  Home &bullet; All Catgegories &bullet; Men's Clothing &
                  Accessories
                </h1>
              </div>
          ...
          <div className="product">
            ...
            <div className="product__detail">
              <div className="product__detail__stars">
                ...
                <img
                  src={starImage}
                  className="star__icon star__icon--white"
                ></img>
                <h1 className="product__detail__stars__heading">
                  Pablo Permins
                </h1>
                <span className="product__detail__stars__span">
                  one hour ago
                </span>
              </div>
              <div className="product__detail__view">
                <p className="product__detail__view__paragrapgh">
                  ...
                  <div className="product__detail__view__communicate__heart">
                    <div className="product__detail__view__communicate__heart__back">
                      <img
                        alt=""
                        src={heartImage}
                        className="product__detail__view__communicate__heart__icon"
                      ></img>
                    </div>
                    <h1 className="product__detail__view__communicate__heart__count">
                      113
                    </h1>
                  </div>
                  ...
                  <div className="product__detail__view__communicate__heart">
                    <div className="product__detail__view__communicate__heart__back">
                      <img
                        alt=""
                        src={bubbleImage}
                        className="product__detail__view__communicate__heart__icon product__detail__view__communicate__heart__icon--black"
                      ></img>
                    </div>
                    <h1 className="product__detail__view__communicate__heart__count">
                      113
            ...
            <div className="add_review__input">
              <form className="add_review__input__form">
                <div className="add_review__input__form__nick">
                  <label className="add_review__input__form__nick__label">
                    Choose a nick name
                  </label>
                  <input
                    type="text"
                    className="add_review__input__form__nick__input"
                  ></input>
                </div>
                <div className="add_review__input__form__your">
                  <label className="add_review__input__form__your__label">
                    Your review
                  </label>
                  <div className="add_review__input__form__your__container">
                    ...
                    <div className="add_review__input__form__your__heading">
                      <h1 className="add_review__input__form__your__heading__gray">
                        Your reviews must be atleast 50 characters
                      </h1>
            ...
            <div className="card__card">
              <div className="card__parent">
                ...
                <div className="card__middle">
                  ...
                  <button className="card__middle__button">Quick View</button>
                </div>
              </div>
              <div className="card__parent">
                <div className="card__hover">
