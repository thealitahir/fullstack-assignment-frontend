                ...
                <footer className="productFooter">
                    <ul className="productFooter__list">
                        <li className="productFooter__list--item">
                            <a className="productFooter__list__link" href="#">Women</a>
                        </li>
                        <li className="productFooter__list--item">
                            <a className="productFooter__list__link" href="#">Men</a>
                        </li>
                        <li className="productFooter__list--item">
                            <a className="productFooter__list__link" href="#">Kids</a>
                        </li>
                        <li className="productFooter__list--item">
                            <a className="productFooter__list__link" href="#">Shoes</a>
                        </li>
                        <li className="footer__list--item">
                            <a className="productFooter__list__link" href="#">Brands</a>
                        </li>
                    </ul>
                    ...
                    <div className="productFooter__copyright">
                        <h1>&copy; 2020 shopmate Ltd <b>Contact</b>  <b>Privacy Policy</b></h1>
                    </div>
                </footer >
            </>
        )
